...
- Key KPIs such as Total Revenue, Total Profit, Quantity Sold, and Average Order Value
- Sales performance comparison by state
- Category-wise quantity distribution
- Monthly profit trends
- Customer-wise revenue contribution
- Payment mode analysis
- Profit analysis by sub-category
- Interactive slicers for quarters and category filtering
...
- Count the number of unique brands sold
- Calculate total profit
- Calculate profit margin
- Create a new column combining region and state
- Categorize products into Small, Medium, and Large based on units sold using conditional logic (IF)
- Calculate revenue from Sprite
